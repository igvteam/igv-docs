...
group |  option tagName |    Alignment tracks only. Group alignments by the specified option. See [below](./#group-option-values) for a list of valid option values. For option "TAG" also specify the tag name.
