...
Select _**Tools > Run igvtools**_ to open the igvtools window. This window allows you to select and run the tools: [***Count***](#count), [***Sort***](#sort), [***Index***](#index), [***toTDF***](#totdf), and ***TDFtoBedGraph***.
...
* **Input File**
    ...
    * The file must be sorted by start position (see the [Sort](#sort) tool)
