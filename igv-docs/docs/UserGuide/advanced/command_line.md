...
The [_Download IGV_](../../downloadPage.md) page includes an option to download IGV along with scripts for launching it on the command line, as well as the igvtools utilities. 
