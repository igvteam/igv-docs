...
relative to the original read sequence. In the BAM format one of the alignments will be designated "primary",
the remaining are designated "supplementary". Both primary and supplementary alignments optionally contain
...
* Standard clipping indicator when no `SA` tag is present:<br>
<img width="30" alt="Screenshot 2023-10-23 at 1 27 11 AM" src="https://github.com/igvteam/igv-docs-website/assets/4700332/01cc7bb4-96e0-46ff-9cd1-163d7395c8f3">
