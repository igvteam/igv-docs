...
* CRAM files created using LZMA compression could not be read. [GitHub issue 1767](https://github.com/igvteam/igv/issues/1767)

* There were problems with Sashimi Plots that were opened when the view had been zoomed in to the maximum level, e.g., when a single base had been entered into the search box. [GitHub issue 1750](https://github.com/igvteam/igv/issues/1750)
